...
1. **Adapters:** express intents to handle common application tasks such as user authentication, file upload, web sockets, and streaming data
2. **Integrations:** intent types for your apps to integrate commonly used third party services (e.g. Stripe, SendGrid, OpenAI, Anthropic)
3. Additional templates and examples
