...
describe("PUT /api/friendships/:id", () => {
  it("should return 401 when authentication is not implemented", async () => {
    ...
    const response = await PUT(request, { params: createMockParams({ id: friendship.id }) });
    const data = await response.json();
...
describe("DELETE /api/friendships/:id", () => {
  it("should return 401 when authentication is not implemented", async () => {
    ...
    const response = await DELETE(createMockRequest() as Request, { params: createMockParams({ id: friendship.id }) });
    const data = await response.json();
