...
const schemas = [
  {
    ...
    definitions: [
      'FieldType', 'FieldAttribute', 'ForeignKey', 'RelationKind', 
      'ReverseRelation', 'FieldRelation', 'Field', 'Provenance', 
      'AIContext', 'AddEntity', 'AddField', 'RemoveField', 
      'AddEndpoint', 'AddComponent', 'AddRelation'
    ]
  },
  {
    name: 'oiml.project',
